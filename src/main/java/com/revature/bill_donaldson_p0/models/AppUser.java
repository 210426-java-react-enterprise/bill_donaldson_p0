package com.revature.bill_donaldson_p0.models;
...
public class AppUser {
    ...
    public AppUser(String username, String password, String email, String firstName, String lastName, int age, String ssn) {
   // public AppUser(String username, String password, String email, String firstName, String lastName, int age) {
    ...
    public String toFileString() {
        return String.format("%s;%s;%s;%s;%s;%d,%s", username, password, email, firstName, lastName, age, ssn);
    }
